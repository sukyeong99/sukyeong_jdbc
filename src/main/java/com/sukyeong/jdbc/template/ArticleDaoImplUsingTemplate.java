package com.sukyeong.jdbc.template;
...
import com.sukyeong.jdbc.raw.Article;
import com.sukyeong.jdbc.raw.ArticleDao;
...
public class ArticleDaoImplUsingTemplate implements ArticleDao {
	...
	public ArticleDaoImplUsingTemplate() {
		dataSource = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/soodb?user=sukyeong&password=123123");
